...
fn windows_gtk_workspace_toolbar_controls_are_wired_to_runtime_state() {
    ...
    assert!(
        WINDOWS_GTK_RUNTIME_RS.contains("TileRuntimeSurface")
            ...
            && WINDOWS_GTK_RUNTIME_RS.contains("install_terminal_focus_reporting")
            && WINDOWS_GTK_RUNTIME_RS.contains("gtk::EventControllerFocus::new()")
            && WINDOWS_GTK_RUNTIME_RS.contains("focus_reporting()")
            && WINDOWS_GTK_RUNTIME_RS.contains("\\u{1b}[I")
            && WINDOWS_GTK_RUNTIME_RS.contains("\\u{1b}[O")
